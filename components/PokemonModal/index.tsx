      ...
      <View style={styles.overlay}>
        <View style={[styles.modalContent, { backgroundColor: bgColor }]}>
          ...
          <View style={styles.nameContainer}>
            <Text style={styles.nameText}>{pokemon.nome.charAt(0).toUpperCase() + pokemon.nome.slice(1)}</Text>
              ...
              <View style={styles.abilitiesContainer}>
                {pokemon.habilidades?.map((ability, index) => (
                  <View key={index} style={styles.abilityBadge}>
                    <Text style={styles.abilityText}>{ability.charAt(0).toUpperCase() + ability.slice(1).replace('-', ' ')}</Text>
                  </View>
                ))}
              </View>
